...
- [What problem does this Log4brains solve?](#what-problem-does-this-log4brains-solve)
...
## What problem does this Log4brains solve?
...
Log4brains is a solution for this problem, but only specifically for ADR (Architecture Design Records), so sad.
